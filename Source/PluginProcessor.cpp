...
VitOttAudioProcessor::VitOttAudioProcessor()
    ...
    parameters(*this, nullptr, juce::Identifier("vitOTT"), {
            ...
            std::make_unique<juce::AudioParameterFloat>("lgain", "Low. Gain", -30, 30, 16.3f),
            std::make_unique<juce::AudioParameterFloat>("mgain", "Mid. Gain", -30, 30, 11.7f),
            std::make_unique<juce::AudioParameterFloat>("hgain", "High. Gain", -30, 30, 16.3f),
